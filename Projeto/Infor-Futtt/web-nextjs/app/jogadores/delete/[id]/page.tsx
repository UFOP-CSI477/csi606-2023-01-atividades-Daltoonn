...
import getByIdCidade from "@/app/repository/jogadores/GetByIdJogadores";

//aqui estamos fazendo a funcao delete e estemos passando os parametros
export default function DeleteCidade({params} : {params : { id : string}}) {
          ...
          <form onSubmit= {handleSubmit}>
              ...
              <label htmlFor="estado">Estado</label>
                  ...
                  >
                      ...
                      <option value={estadoId} disabled>Selecione:</option>
